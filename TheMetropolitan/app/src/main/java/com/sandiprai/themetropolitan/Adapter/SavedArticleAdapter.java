...
public class SavedArticleAdapter extends RecyclerView.Adapter<SavedArticleAdapter.ViewHolder> {
    ...
    public SavedArticleAdapter(List<String> articleList, Context context) {
    ...
    @NonNull
    @Override
    public SavedArticleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
